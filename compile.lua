...
function addMoveAPI() --Injects the moveapi into the start of the .lua file for goscript to take advantage of
    ...
    writeF("            harvestLevel = 7")
    writeF("        elseif data.name == 'ExtraUtilities:plant/ender_lilly' then")
    writeF("            isPlant = true")
    writeF("            harvestLevel = 7")
    writeF("            seeds = 'ExtraUtilities:plant/ender_lilly'")
    writeF("        else")
    writeF("            isPlant = false")
    writeF("        end")
